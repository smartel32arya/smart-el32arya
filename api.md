...
- `file` (file, required) — image or video file.
  ...
  - Videos: `video/mp4`, `video/quicktime`, `video/x-msvideo`, `video/webm` — max 100 MB
...
- `video` (file, required) — video file. Accepted MIME types: `video/mp4`, `video/quicktime`, `video/x-msvideo`, `video/webm`. Max size: 100 MB.
